...
let Family = [
  ...
  },
  {
    ...
    "name": "Mini PC",
    "image": "mini_pc.jpg",
    "description": "Ordenador de sobremesa compacto y eficientelet productos = localStorage.getItem('productes') ? JSON.parse(localStorage.getItem('productes')) : Product; en energía.",
    "parent_id": 5
  }
]
